...
namespace MicroRabbit.Infra.Bus
{
    public sealed class RabbitMQBus : IEventBus
    {
        ...
        public RabbitMQBus(IMediator sender, IServiceScopeFactory serviceScopeFactory)
        {
            _sender = sender;
        ...
        public void Publisher<T>(T @event) where T : Event
        {
        ...
        public Task SendCommand<T>(T command) where T : Command => _sender.Send(command);
